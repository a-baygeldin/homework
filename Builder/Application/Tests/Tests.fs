...
module getIntersectTests =
    ...
    [<Test>]
    let ``LineSegment as VerticalLine`` () = Assert.AreEqual ((getIntersect (Intersect (LineSegment ((7.23425, 1.23534), (7.23425, 10.64563)), VerticalLine (7.23425))) == LineSegment ((7.23425, 1.23534), (7.23425, 10.64563))), true)
    [<Test>]
